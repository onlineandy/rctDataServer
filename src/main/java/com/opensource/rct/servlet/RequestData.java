...
public class RequestData {
    ...
    public String getRctData(HttpServletRequest request, HttpServletResponse response) {
        if (request.getParameterMap().containsKey("magicNumber")) {
            ...
            if (!(magicNumber == null || magicNumber.equalsIgnoreCase(""))) {
                if (MagicNumber.magicNumberObjectMap.containsKey(magicNumber))
                //if(Constants.keyDescriptionMapNumber.containsKey(magicNumber))
                {
                    MagicNumber.magicNumberObjectMap.get(magicNumber).setDataReady(false);

                    if (MagicNumber.magicNumberObjectMap.get(magicNumber).getDataType().equalsIgnoreCase("short")) {
                    ...
                    } else if (MagicNumber.magicNumberObjectMap.get(magicNumber).getDataType().equalsIgnoreCase("long")) {
                    ...
                    } else if (MagicNumber.magicNumberObjectMap.get(magicNumber).getDataType().equalsIgnoreCase("string")) {
    ...
    private void sendRequestToInverter(byte[] inputByteArray) {
        ...
        if (requestTimeOut) {
            ...
            content = MagicNumber.magicNumberObjectMap.get(magicNumber).getDataJson().toString();
